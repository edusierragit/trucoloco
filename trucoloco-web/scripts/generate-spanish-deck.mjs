...
function figureSymbol(suit, rank) {
  ...
  const crown =
    rank === "12"
      ? `<path d="M-58-85L-28-48L0-92L28-48L58-85V-24H-58Z" fill="#d9a134" stroke="${suit.dark}" stroke-width="5" stroke-linejoin="round"/>`
      : "";
  const horse =
    rank === "11"
      ? `<path d="M-56 36C-30 8-6-6 33-3C58-1 68 19 53 43C33 27 8 29-18 56Z" fill="#d9c4a3" stroke="${suit.dark}" stroke-width="6" stroke-linejoin="round"/>`
      : "";
