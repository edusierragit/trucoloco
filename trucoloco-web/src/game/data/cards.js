...
const card = (id, name, suit, power, tone, lane = "Cartachin", flavor = "", group = "truco") => ({
  ...
  group,
  image:
    group === "truco" || group === "bonus" ? assetUrl(`assets/cards/fronts/${id}.svg?v=${CARD_ASSET_VERSION}`) : null,
...
export const deck = [
  card(
    ...
    "#d6a24b",
    "Jugador Estrella",
    "La carta que te hace pararte de la silla."
  ),
  card(
    "ancho-basto",
    "Ancho de Basto",
    ...
    "#7ca85e",
    "Negociante",
    "No luce tanto, pero te acomoda la cara."
  ),
  ...
  card(
    ...
    "#a8bfa0",
    "Jugador Estrella",
    "Gallopa hacia la derrota con dignidad."
  ),
...
export const bonusCards = [
  card(
    ...
    "#d7f2ff",
    "Jugador Estrella",
    "Le cae del cielo a Gazpacho y todos se pudren.",
    "bonus"
  ),
  card(
    "mago-oscuro",
    ...
    "#9267cf",
    "Cartachin",
    "Huele a trampa y colonia barata.",
    "bonus"
  ),
  card(
    "kuriboh-quincho",
    ...
    "#7c5b43",
    "Cartachin",
    "Insoportable, pero siempre aparece.",
    "bonus"
  ),
  card(
    "ancho-falso",
    ...
    "#dd5a28",
    "Cartachin",
    "Asusta de lejos; de cerca da lastima.",
    "bonus"
  ),
  card(
    "el-relator",
    ...
    "#c46d1a",
    "Negociante",
    "Cuando habla, la mano cambia de dueno.",
    "bonus"
  ),
  card(
    "carta-robada",
    ...
    "#8b3a52",
    "Jugador Estrella",
    "Nadie sabe de donde salio, pero esta ahi.",
    "bonus"
  ),
  card(
    "carta-messi",
    ...
    "#75c9f0",
    "Jugador Estrella",
    "La pulga no negocia. Gambetea la vuelta entera.",
    "bonus"
  ),
  card(
    "exodia",
    ...
    "#d4a020",
    "Jugador Estrella",
    "El brazo derecho ya esta en la mesa. Propiedad de Gazpacho.",
    "bonus"
  ),
  card(
    "fisura-dimensional",
    ...
    "#6a4fd0",
    "Jugador Estrella",
    "Se abre el piso y la carta rival duerme abajo.",
    "bonus"
  )
];
